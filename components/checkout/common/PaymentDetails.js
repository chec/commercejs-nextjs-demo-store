          ...
          <div className="pl-5 pr-3 pb-3 ml-2">
            <div className="row">
              ...
              <div className="col-sm-3">
                <label className="w-100 mb-3 mt-2 mb-sm-0">
                  <p className="mb-1 font-size-caption font-color-light">CVC (CVV)</p>
                  <input
                    name="cvc"
                    value={cvc}
                    maxLength="3"
              ...
              <div className="col-sm-3">
                <label className="w-100 mb-3 mt-2 mb-sm-0">
                  <p className="mb-1 font-size-caption font-color-light">Exp. Month</p>
                  <input
                    name="expMonth"
                    type="number"
                    value={expMonth}
              ...
              <div className="col-sm-3">
                <label className="w-100 mb-3 mt-2 mb-sm-0">
                  <p className="mb-1 font-size-caption font-color-light">Exp. Year</p>
                  <input
                    type="number"
                    name="expYear"
                    value={expYear}
    ...
    return (
      <div className="borderbottom border-color-gray500">
        <label
          ...
          className="p-3 d-flex align-items-center cursor-pointer"
        >
          <Radiobox checked={selectedGateway === "manual"} className="mr-3" />
          <p className="font-weight-medium">Transfer Bank</p>
        </label>

        {selectedGateway === "manual" && (
          <div className="pl-5 pr-3 pb-3 ml-2">
            <p>{gateways.manual[0].details}</p>
          </div>
        )}
      </div>
    );
