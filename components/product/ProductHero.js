      ...
      <div className="py-5 my-5">
        <div className="custom-container pt-4">
          <div className="row">
            ...
            <AboutProduct className="d-block d-sm-none" />
            ...
            <div className="col-12 col-sm-6 col-lg-5">
              <div className="d-flex">
                <div className="ml-lg-3 mr-3 d-none d-sm-block">
                  {images.map(image => (
                    <div
                      className="h-56 w-48 border border-color-black mb-3 border-width-2"
                      style={{
            ...
            <div className="col-sm-6 col-lg-5 col-xl-4">
              <div className="pl-sm-5 pr-sm-3">
                <AboutProduct className="d-none d-sm-block" />

                {/* Desktop Add to cart */}
                <div className="d-none d-sm-block">
                  <div className="mb-3">
                    <span className="mr-3 font-weight-semibold">SIZE:</span>
                    {["500ML", "1000ML"].map(name => (
                      <span className="mr-3">{name}</span>
                    ))}
                  </div>
                  <div className="mb-4">
                    <span className="mr-3 font-weight-semibold">COLOR:</span>
                    {["PURPLE", "BLUE", "RED"].map(name => (
                      <span className="mr-3">{name}</span>
                    ))}
                  </div>
                  <div className="d-flex py-4">
                    <button className="h-56 font-weight-medium bg-white border border-color-black pl-3 pr-4 mr-3 d-flex align-items-center">
                      <img src="/icon/heart.svg" className="mr-2" />
                      Save
                    </button>
                ...
                <div className="d-flex cursor-pointer py-3 justify-content-between borderbottom border-color-black">
  ...
  return (
    <div {...rest}>
      <div className="d-flex">
        ...
        <span className="ml-2 font-size-caption font-weight-semibold">5/5</span>
      </div>
